...
namespace OurGP.Nodes.Expressions
{
    public class WhileStatement : Expression
    {
        ...
        //* Grow constructor
        public static new WhileStatement Grow(int maxDepth, int minDepth = 0, int currentDepth = 0, Node? parent = null)
        {
            ...
            node.Block = ExpressionList.Grow(maxDepth, minDepth, currentDepth + 1, node);
            return node;
        }
